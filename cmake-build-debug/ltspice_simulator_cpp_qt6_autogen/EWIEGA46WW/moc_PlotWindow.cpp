...
template <> constexpr inline auto PlotWindow::qt_create_metaobjectdata<qt_meta_tag_ZN10PlotWindowE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        QtMocHelpers::SlotData<void(QLineSeries *, const QPointF &)>(10, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { 0x80000000 | 11, 12 }, { QMetaType::QPointF, 13 },
        }}),
        // Slot 'clearCursor'
...
void PlotWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->saveDataToFile(); break;
        case 2: _t->horizontalScaleChanged((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        case 3: _t->showContextMenu((*reinterpret_cast< std::add_pointer_t<QPoint>>(_a[1]))); break;
        case 4: _t->changeSeriesColor(); break;
        case 5: _t->renameSeries(); break;
        case 6: _t->onSeriesClicked((*reinterpret_cast< std::add_pointer_t<QLineSeries*>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QPointF>>(_a[2]))); break;
        case 7: _t->clearCursor(); break;
        case 8: _t->handleLegendClick(); break;
        default: ;
        }
    }
